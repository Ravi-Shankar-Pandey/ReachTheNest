...
public class GameActivity extends AppCompatActivity {
    private ImageView bird,enemy1,enemy2,enemy3,coin1,coin2;
    private ImageView right1,right2,right3;
    private TextView textViewScore,getTextViewScoreInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getTextViewScoreInfo=findViewById(R.id.textViewStartInfo);
        constraintLayout=findViewById(R.id.constraintLayout);

        constraintLayout.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                getTextViewScoreInfo.setVisibility(View.INVISIBLE);
    ...
    public  void collisionControl()
    {
       ...
       else if (score >= 500)
       {
           ...
           getTextViewScoreInfo.setVisibility(View.VISIBLE);
           getTextViewScoreInfo.setText("Congratulation. You Won The Game.");
